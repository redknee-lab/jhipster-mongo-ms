...
import static com.lukethep.domain.ProductAsserts.*;
import static com.lukethep.web.rest.TestUtil.createUpdateProxyForBean;
import static com.lukethep.web.rest.TestUtil.sameNumber;
...
class ProductResourceIT {
    ...
    public static Product createEntity() {
        return new Product().name(DEFAULT_NAME).price(DEFAULT_PRICE);
    }
    ...
    public static Product createUpdatedEntity() {
        return new Product().name(UPDATED_NAME).price(UPDATED_PRICE);
    }
